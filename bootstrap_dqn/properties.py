...
def build_parser():
    ...
    parser.add_argument("--memory_size", dest="memory_size", metavar="memory_size", type=int, default=int(5e5))
    ...
    parser.add_argument("--n_ensemble", dest="n_ensemble", type=int, default=1)
